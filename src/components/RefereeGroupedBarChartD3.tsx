...
const METRIC_COLORS = {
  yellow: "#FFD700",   // Gold
  double: "#FF8C00",   // Dark Orange
  red: "#D32F2F",      // Red
  penalty: "#2C3E50"   // Dark Blue/Grey
};
...
const RefereeGroupedBarChartD3: React.FC<Props> = ({ data }) => {
  ...
  useEffect(() => {
    ...
    // A. Prepare Data: Top 15 Strictest
    const topRefs = [...data]
    ...
    // X1: Subgroup scale (The 4 bars per referee)
    const x1 = d3.scaleBand()
      .domain(keys)
      .rangeRound([0, x0.bandwidth()])
      .padding(0.05);

    // Calculate max Y value (per game stats)
