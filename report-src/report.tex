...
Szymon created the initial project structure including layout, took part in visualization designed and implemented referee specific charts (Referee Passport and Card DNA). Also was invloved in some minor improvements and fixes.
